...
### spadesCBMdb
in spadesCBM, output tables for each simulation year are saved into a object called `spadesCBMdb` this object is a path to a directory containing the output tables for each simulation year as `.qs` files. By default, 3 tables are saved per simulation year: `key`, `pools`, and `flux`.
